...
const StatsCard = () => {
  return (
    <div className=" gap-4 grid-cols-1 sm:grid-cols-2 max-w-lg mx-auto flex flex-col">
      {/* Visitors Card */}
      <div className="p-6 bg-color3 text-black rounded-lg shadow-md flex justify-between items-center">
        <div>
      ...
      {/* Page Views Card */}
      <div className="p-6  bg-gray-900 text-lime-400 rounded-lg shadow-md flex justify-between items-center">
        <div>
